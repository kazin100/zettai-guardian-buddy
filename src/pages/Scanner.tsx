...
import { ScanSearch, Shield, AlertTriangle, CheckCircle2, XCircle, Loader2 } from "lucide-react";
          ...
          <div className="card-cyber p-6 border-glow mb-8">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 bg-input border border-border rounded-lg px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/50 font-mono text-sm"
              />
              <Button variant="cyber" onClick={handleScan} disabled={loading} className="gap-2">
              ...
              <div className="card-cyber p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    {result.https ? "Conexão segura ativa" : "Sem HTTPS - Conexão não segura!"}
                  </div>
                </div>
              </div>
